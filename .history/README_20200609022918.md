...
Inside this file you can place your api key like this: <code>FLICKR_API_KEY = YOUR_FLICKR_API_KEY</code>. There's also a keys.example.xcconfig file you can use to copy this simple configuration.
